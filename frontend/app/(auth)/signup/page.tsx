...
const Signup = () => {
    return (
        <>
            <Button className="flex w-[calc(100%-2rem)] m-4 p-4 bg-blue-400 h-16 items-center justify-between relative"> <span className='bg-white flex rounded p-2 my-4 mx-2 items-center justify-center'><GoogleSvg /> </span> <span className='text-center text-xl absolute left-1/2 transform -translate-x-1/2'> Sign up with Google </span></Button>
            ...
            <Button className="w-[calc(100%-2rem)] m-4 mt-8 p-4 bg-orange-500 text-white h-12 text-lg"> Get Started </Button>
